...
public class NuSkinHomePage {
  ...
  //  private By addCartButton = By.xpath("//button[@class='ns-product-detail__add-to-cart fluid primary-solid']");
    ...
    private By searchBoxHome = By.xpath("//input[@class='search-input']");
    private By sanbList = By.xpath("//li[@class='secondary-nav']//ul//li[@class='tertiary-nav']//a");
    private By productLinesDropDown = By.xpath("//div[@class='NsTabsWrapper__container']//div[@class='NsTab__container']//span[contains(text(),'Product Lines')]");
    private By productLineList = By.xpath("//ul[@class='navigation-list']//ul//li[@class='tertiary-nav']//a");
...
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
        ...
        public void typeSearchBox() {
            WebElement inputBox = driver.findElement(searchBoxHome);
            inputBox.sendKeys("Facial");
            inputBox.sendKeys(Keys.ENTER);

        }
        public void createSkinBeautyList() {
                WebElement sbdrop = driver.findElement(sandbDropDown);
                Actions act1 = new Actions(driver);
                act1.moveToElement(sbdrop).perform(); // hover over skin and beauty

                List<WebElement> sbdropdown = driver.findElements(sanbList);
            System.out.println("******Skin and Beauty List******");
                for (WebElement we : sbdropdown) {
            ...
            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(4));
                ...
                WebElement proddrop = driver.findElement(productLinesDropDown);
            Actions act2 = new Actions(driver);
            act2.moveToElement(proddrop).perform(); // hover over Product Line

            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(2));
            List<WebElement> productlineDropdownList = driver.findElements(productLineList);
            System.out.println("*****Product Line List********");
            for(WebElement pl: productlineDropdownList){
                String text2 = pl.getText();
